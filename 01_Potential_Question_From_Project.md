...
**Ans:** Azure Data Factory (ADF) is a cloud-based data integration service that allows you to create data-driven workflows for orchestrating and automating data movement and data transformation. It is used in data engineering to:
...
**Ans:** To create and schedule a pipeline in ADF:
...
**Ans:** ADLS Gen2 is a scalable, high-performance cloud storage solution optimized for big data analytics. Key features include:
...
**Ans:** Azure Databricks is a cloud-based analytics platform optimized for Apache Spark. It provides a collaborative workspace for:
...
**Ans:** Yes, Synapse can function as a data lakehouse by:
...
**Ans:** The medallion architecture organizes data into three layers:
